...
setInputData({...inputData, [name]:value});
    ...
    useEffect(()=>{
        ...
        setUserProfile(authState.user)
         let post = postReducer.posts.filter((post)=> post.userId.username === authState.user.userId.username);
    ...
    <UserLayout>
        <DashboardLayout>
            ...
            <div className={styles.backDropContainer}>
             ...
             <div className="workHistory">
                  ...
                  <div className={styles.workHistoryContainer}>
                    ...
                    onClick={()=>setIsModalOpen(true)}>Add Work</button>
                  </div>
             </div>
          ...
          className={styles.allCommentsContainer}>
            <input type='text' placeholder='Enter Company' name='company' onChange={handleWorkInputChange} className = {styles.inputField} />
            <input type='text' placeholder='Enter Position' name='position' onChange={handleWorkInputChange} className = {styles.inputField} />
            <input type='number' placeholder='Years' name='years' onChange={handleWorkInputChange} className = {styles.inputField} />
            <div onClick={()=>{
