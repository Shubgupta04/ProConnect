...
export default function ViewProfilePage({userProfile}) {
  ...
  const [isConnecNull, setIsConnectionNull] = useState(true);
        ...
        <div className={styles.container}>
            <div className={styles.backDropContainer}>
             ...
             <div className={styles.profileContainer_details}>
                  <div className={styles.profile_flexContainer}>
                <div style={{flex:"0.8"}}>
                  ...
                  <button className={styles.connectedButton}>{setIsConnectionNull ? "Pending" : "Connected"}</button>
                  :
...
export async function getServerSideProps(context){
  ...
  console.log("Response from get profile based on username",request.data);
  return{
    props:{
